import cubeVert from "../shaders/cube_videoTexture/cube.vert.wgsl?raw"
import cubFrag from "../shaders/cube_videoTexture/cube_videoTexture.frag.wgsl?raw"
import videoUrl from '../images/video.mp4?url'
...
async function draw(
    ...
    function frame(){
        ...
        // todo 2.创建sampler、video texture和相应的textureGroup
        const texture = device.importExternalTexture({
            source: video
        });
        const videoTextureGroup = device.createBindGroup({
        ...
        passEncoder.setBindGroup(1, videoTextureGroup);
